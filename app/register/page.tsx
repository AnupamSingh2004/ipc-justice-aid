      ...
      <div className="w-full max-w-md p-6 animate-fade-in">
        ...
        <Card className="justice-card border-blue-900 dark:border-amber-400 border-l-0 border-t-0 border-r-0 border-b-0">
          <CardHeader className="space-y-1 pb-2">
            <CardTitle className="text-xl font-bold text-center text-blue-900 dark:text-amber-400">Create Account</CardTitle>
          </CardHeader>
          <CardContent>
          ...
          <CardFooter>
            <p className="text-center text-sm text-gray-600 dark:text-gray-400 w-full">
              ...
              <Link href="/login" className="text-blue-900 dark:text-amber-400 hover:underline font-medium">
                Sign in
              </Link>
            </p>
          </CardFooter>
