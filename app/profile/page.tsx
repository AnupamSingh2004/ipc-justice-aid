      ...
      <div className="container px-6 py-8 max-w-6xl mx-auto animate-fade-in">
            ...
            <div className="justice-card border-red-700">
              ...
              <div className="flex flex-col items-center text-center my-6">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">
                  {searchCount < 200
                    ? `${200 - searchCount} more searches until expert status`
                    : "Legal expert status achieved!"}
                </p>
              </div>
        ...
        <div className="mt-10 text-center">
          <p className="text-sm text-gray-500 dark:text-gray-400">
            Your profile information is stored securely and not shared with
            third parties.
          </p>
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">
            Disclaimer: This tool provides informational guidance only and
            should not be considered legal advice. Always consult with a
